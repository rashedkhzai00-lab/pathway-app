    ...
    <div className="min-h-[100dvh] w-full bg-paper flex flex-col items-center justify-center px-4 py-12 relative">
      ...
      <div className="card-container flex flex-col gap-6" style={{ maxWidth: 480 }}>
        ...
        <div
          ...
          style={{ background: "hsl(210 25% 48% / 0.12)" }}
          aria-hidden="true"
        >
          <PenLine className="w-8 h-8" style={{ color: "var(--color-dusty-blue)" }} />
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-ink-soft leading-relaxed" data-testid="text-subtitle">
            {type === "fix"
              ? "Fix and improve existing questions — coming here next."
              : "Create new questions from your notes — coming here next."}
          </p>
        </div>
        ...
        >
          <span
            ...
            style={{ background: "hsl(210 25% 48% / 0.4)" }}
          />
          Coming soon
        </div>
